...
async def send_expired_notification(bot):
    ...
    await broadcaster(bot, user_list, message=message_texts['subscription_expired_in_day'],
...
async def kick_members_with_ended_sub(bot):
    ...
    await broadcaster(bot, user_list, message=message_texts['subscription_kick'],
